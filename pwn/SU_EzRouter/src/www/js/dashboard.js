...
window.fakeOnlineUpgrade = function (btn) {
    ...
    // 变成加载状态
    btn.innerHTML = '<svg class="spinner" viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><path d="M21 12a9 9 0 1 1-6.219-8.56"></path></svg> 正在连接更新服务器...';
    btn.disabled = true;
...
window.factoryReset = function () {
    ...
    const originalText = btn.innerHTML;
    btn.innerHTML = '<svg class="spinner" viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2" fill="none"><path d="M21 12a9 9 0 1 1-6.219-8.56"></path></svg> 正在擦除 NVRAM...';
    btn.disabled = true;
